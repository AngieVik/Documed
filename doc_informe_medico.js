...
const DOC_INFORME_MEDICO = {
  ...
  getSections() {
    return [
        ...
        <div id="resolucion-plan" class="section-block page-break-avoid">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-3">
            ...
            <div id="seccion-destino">
              ...
              <div class="flex gap-2"> <select id="provincia-selector" required class="w-1/3 border-b border-slate-300 bg-transparent py-1 text-xs text-slate-800 focus:outline-none focus:border-blue-600 invalid:text-slate-400">
                  <option value="" disabled selected hidden></option>
                </select>
      ...
      `,
      UI_COMPONENTS.firmas("Firma del Paciente", UI_COMPONENTS.categoriaField("Facultativo"))
    ];
  },
